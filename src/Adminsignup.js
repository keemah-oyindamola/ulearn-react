...
const Adminsignup = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (value) => {
            ...
            // } else {
                console.log(value);
                axios.post("http://localhost:5000/admin/signup", value)
                    .then((res) => {
            ...
            <form onSubmit={formik.handleSubmit} action="">
                <div className='first-div'>
                    <div className='content-center'>
                        ...
                        <p className='ptag'>By signing up, you agree to our <a className='ptag-a'>Terms of Use</a> and <a className='ptag-a' href="">Privacy Policy</a>.</p>
                        {/* <hr /> */}
                        <p className='ptag'>Already have an account? <Link to='/adminlogin'><a to='/adminlogin' className='login' href="">Log in</a></Link></p>
                        <ToastContainer />
                        {/* </div> */}
                    </div>
                </div>
